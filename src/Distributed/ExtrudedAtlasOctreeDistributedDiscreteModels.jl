...
GridapDistributed.get_face_gids(m::ExtrudedAtlasOctreeDistributedDiscreteModel, dim::Integer) =
...
function Base.getproperty(m::ExtrudedAtlasOctreeDistributedDiscreteModel, sym::Symbol)
  if sym === :face_gids
...
Base.propertynames(m::ExtrudedAtlasOctreeDistributedDiscreteModel) =
...
function generate_extruded_octree_distributed_refined_models(ranks,
  ...
  models = Vector{ExtrudedAtlasOctreeDistributedDiscreteModel}(undef,n_ref_lvls)
