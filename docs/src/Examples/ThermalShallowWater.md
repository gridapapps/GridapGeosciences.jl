```@meta
EditURL = "../../../test/Examples/ThermalShallowWater.jl"
```
...
```math
\begin{align*}
\widetilde{\boldsymbol{F}} &= \widetilde{\varphi}\widetilde{\boldsymbol{u}} , \qquad
\widetilde{\Phi} = \frac{1}{2} \widetilde{\boldsymbol{u}}\cdot\widetilde{\boldsymbol{u}} + \frac{1}{2} \widetilde{B}  ,\qquad
\widetilde{\vartheta} = \frac{1}{2} \widetilde{\varphi} \\
\widetilde{q} &= \frac{1 }{\widetilde{\varphi}}(\nabla_{\gamma}^\dagger\cdot \widetilde{\boldsymbol{u}}  + f) , \qquad
\widetilde{b} = \frac{\widetilde{B}}{\widetilde{\varphi}}
\end{align*}
```
